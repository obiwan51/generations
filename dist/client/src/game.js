...
import { AudioSystem, InputSystem, UISystem, RenderSystem } from './systems/index.js';
// Game state
let myId = null;
let players = {};
let world = null;
...
input.setPlayersDataGetter(() => players);
    ...
    onPlayerStatUpdate: (data) => {
        if (players[data.id]) {
            if (data.age !== undefined)
                players[data.id].age = data.age;
            if (data.hunger !== undefined)
                players[data.id].hunger = data.hunger;
            if (data.maxHunger !== undefined)
                players[data.id].maxHunger = data.maxHunger;
            if (data.holding !== undefined)
                players[data.id].holding = data.holding;
            if (data.holdingData !== undefined)
                players[data.id].holdingData = data.holdingData;
            if (data.heldBy !== undefined)
                players[data.id].heldBy = data.heldBy;
            if (data.holdingPlayerId !== undefined)
                players[data.id].holdingPlayerId = data.holdingPlayerId;
            if (data.name !== undefined)
                players[data.id].name = data.name;
            if (data.inBoat !== undefined)
                players[data.id].inBoat = data.inBoat;
            if (data.isDead !== undefined)
                players[data.id].isDead = data.isDead;
            if (data.backpack !== undefined)
                players[data.id].backpack = data.backpack;
            if (data.backpackData !== undefined)
                players[data.id].backpackData = data.backpackData;
        }
    },
    onWorldUpdate: (data) => {
        if (!world)
        ...
        if (data.type === null) {
            ...
            if (data.data)
                world.objectsData[key] = data.data;
            else
                delete world.objectsData[key];
        }
    },
