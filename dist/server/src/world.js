...
class World {
    ...
    seed;
    autoSaveTimer = null;
    autoSaveDelay = 30000; // Save 30 seconds after last change
    isSaving = false;
    lastSaveTime = 0;
    minSaveInterval = 15000; // Minimum 15 seconds between saves
